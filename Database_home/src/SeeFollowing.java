...
public class SeeFollowing {
	...
	SeeFollowing() {
		...
		JLabel NameLabel = new JLabel("Following");
		...
		JButton btnFollow22 = new JButton("Unfollow");
		...
		JButton btnName22 = new JButton("Shinwuk");
		...
		JButton btnFollow33_1 = new JButton("Unfollow");
		...
		JButton btnKimwon = new JButton("Kimwon");
		...
		JTextArea txtrFindMorePeople = new JTextArea();
		txtrFindMorePeople.setForeground(new Color(42, 162, 242));
		txtrFindMorePeople.setFont(new Font("Calibri", Font.BOLD, 20));
		txtrFindMorePeople.setText("Find more people in Explore");
		txtrFindMorePeople.setBounds(178, 37, 248, 24);
		frmWelcomeTwitter.getContentPane().add(txtrFindMorePeople);
